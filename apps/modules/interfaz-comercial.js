...
function mount(){
 ...
 new MutationObserver((window.PoladentPerformance?.debounce(pcRefresh,120))||pcRefresh).observe(panel,{childList:true,subtree:true});
}
...
function buildReports(page){
 ...
 <div class="pc-report-head"><div><span class="pc-report-kicker">Centro de reportes</span><h3>Cronograma profesional de asistencia</h3><p>Selecciona el período y la información que deseas consultar antes de exportar.</p></div><div class="pc-report-badge">📊</div></div>
