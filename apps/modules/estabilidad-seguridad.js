...
function boot(){installLoadingGuard();addStatus();setStatus();installErrorGuard();window.addEventListener('online',setStatus);window.addEventListener('offline',setStatus);}
